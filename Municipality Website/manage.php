...
<head>
  ...
  <meta http-equiv="refresh" content="10; url=/pothole/manage.php">
...
<body style="background-image: url(https://images.unsplash.com/photo-1529186405194-c57220dec7c0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1060&q=80);background-size: cover;background-repeat: no-repeat;">
	<div class="container">
      ...
      <form method="POST" action=""><input type="submit" name="ma" value="Monitor" class="btn btn-sm btn-danger">&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="sub" value="Logout" class="btn btn-sm btn-danger"></form>
		</div>
		<div style="background-color: rgba(0,0,0,0.6);">
		<table class="table table-hover" style="color: white">
        <th>S.No</th><th>Location</th><th>Depth</th>
        ...
        <tr>
          ...
          <td><a href="cancel.php?sno=<?php echo $r['sno']; ?>"><button class="btn btn-sm btn-danger">Resolved</button></a></td>
        </tr>
  <?php }}?>
      </table>
      <?php
